...
import com.dsp.main.Utils.Font.msdf.FontData.AtlasData;
import com.dsp.main.Utils.Font.msdf.FontData.GlyphData;
import com.dsp.main.Utils.Font.msdf.FontData.MetricsData;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifier = ResourceLocation.fromNamespaceAndPath("dsp", "fonts/" + dataFileName + ".json");
			return this;
		}

		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = ResourceLocation.fromNamespaceAndPath("dsp", "fonts/" + atlasFileName + ".png");
			return this;
		}
