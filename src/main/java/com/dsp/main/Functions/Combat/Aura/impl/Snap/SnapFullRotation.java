...
/*
* @was_record
* Да это мои старые снапы, ну и похуй, главное что работают, новые писать слишком долго, тк база не предусмотрена
* Created: 21.07.2025 : 21:26
*/


public class SnapFullRotation extends RotationAngle {
    @Override
