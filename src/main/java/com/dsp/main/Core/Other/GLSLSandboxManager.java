...
public class GLSLSandboxManager {
	public static final String VERTEX_SORUCE = String.valueOf(FileUtil.getShaderSource("vertex.vsh"));
	...
	public GLSLSandboxManager(String fragmentShaderName) {
		...
		try {
			...
			GlStateManager.glShaderSource(vertexShader, Collections.singletonList(VERTEX_SORUCE));
