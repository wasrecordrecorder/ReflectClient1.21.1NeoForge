...
import com.dsp.main.UI.ClickGui.Theme.ThemesFrame;
...
public class ClickGuiScreen extends Screen {
    ...
    public void tick() {
        ...
        for (Frame categoryFrame : categoryFrames) {
            categoryFrame.updatePosition(elapsed);
        }
    }
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        boolean anyInputActive = categoryFrames.stream()
                ...
                .anyMatch(com.dsp.main.UI.ClickGui.Components.Component::isInputActive);
